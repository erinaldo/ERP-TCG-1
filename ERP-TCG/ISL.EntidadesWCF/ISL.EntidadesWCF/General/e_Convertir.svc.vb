...
<DataContract()> _
Public Class e_Convertir
    Implements Ie_Convertir

    Public Function ConvertirDataTable(ByVal items As System.Collections.Generic.List(Of Object)) As System.Data.DataTable Implements Ie_Convertir.ConvertirDataTable
