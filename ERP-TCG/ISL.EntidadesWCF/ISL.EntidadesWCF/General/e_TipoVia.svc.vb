''' <summary>
''' Clase para definir la entidad: TipoVia
''' </summary>
''' <remarks></remarks>
<DataContract()> _
Public Class e_TipoVia
    Implements Ie_TipoVia
...
#Region "Métodos"
    ...
    Public Function Obtener(ByVal tipoVia As e_TipoVia) As e_TipoVia Implements Ie_TipoVia.Obtener
        Return tipoVia
    End Function
