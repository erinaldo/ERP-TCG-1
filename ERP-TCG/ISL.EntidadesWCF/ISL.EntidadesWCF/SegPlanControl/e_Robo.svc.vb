' NOTA: puede usar el comando "Cambiar nombre" del menú contextual para cambiar el nombre de clase "e_Robo" en el código, en svc y en el archivo de configuración a la vez.
' NOTA: para iniciar el Cliente de prueba WCF para probar este servicio, seleccione e_Robo.svc o e_Robo.svc.vb en el Explorador de soluciones e inicie la depuración.
Public Class e_Robo
    Implements Ie_Robo
    Implements IEquatable(Of e_Robo)
...
#Region "Propiedades"
    ...
    <DataMember()> _
    Public leAreaRobo As New List(Of e_AreaResponsableEvento)
...
#End Region
    ...
    Public Overloads Function Equals(ByVal oeRobo As e_Robo) _
    As Boolean Implements System.IEquatable(Of e_Robo).Equals
        If Me.Identificador = oeRobo.Identificador Then
            Return True
        Else
            Return False
        End If
    ...
    Public Sub DoWork() Implements Ie_Robo.DoWork
    End Sub
End Class
