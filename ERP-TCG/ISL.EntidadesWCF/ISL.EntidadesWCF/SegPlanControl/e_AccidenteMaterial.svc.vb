...
<DataContract()> _
Public Class e_AccidenteMaterial
    Implements Ie_AccidenteMaterial
...
#End Region
    ...
    Public Function Obtener(ByVal accidentematerial As e_AccidenteMaterial) As e_AccidenteMaterial Implements Ie_AccidenteMaterial.Obtener
        Return accidentematerial
    End Function
