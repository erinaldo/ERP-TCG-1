<DataContract()> _
Public Class e_ConfiguracionPlanilla
    Implements Ie_ConfiguracionPlanilla
...
#Region "Metodos"
    ...
    Public Function obtener(oeConfiguracionPlanilla As e_ConfiguracionPlanilla) As e_ConfiguracionPlanilla Implements Ie_ConfiguracionPlanilla.obtener
