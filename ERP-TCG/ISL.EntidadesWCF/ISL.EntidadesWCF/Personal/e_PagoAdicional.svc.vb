<DataContract()> _
Public Class e_PagoAdicional
    Implements Ie_PagoAdicional
...
#Region "Metodos"
    ...
    Public Function obtener(oePagoAdicional As e_PagoAdicional) As e_PagoAdicional Implements Ie_PagoAdicional.obtener
