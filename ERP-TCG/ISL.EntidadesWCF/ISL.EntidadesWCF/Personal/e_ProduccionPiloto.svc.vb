<DataContract()> _
Public Class e_ProduccionPiloto
    Implements Ie_ProduccionPiloto
...
#Region "Metodos"
    ...
    Public Function obtener(oeProduccionPilito As e_ProduccionPiloto) As e_ProduccionPiloto Implements Ie_ProduccionPiloto.obtener
        Return oeProduccionPilito
    End Function
