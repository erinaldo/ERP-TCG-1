...
Public Class l_Cliente
    ...
    Public Function ComboGrilla(ByVal ListaCliente As System.Collections.Generic.List(Of e_Cliente)) As Object Implements Il_Cliente.ComboGrilla
        Try
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function Eliminar(ByVal oeCliente As e_Cliente) As Boolean Implements Il_Cliente.Eliminar
        Try
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function Guardar(ByVal oeCliente As e_Cliente) As Boolean Implements Il_Cliente.Guardar
        Try
    ...
    Public Function GuardarCliente(ByVal oeCliente As e_Cliente) As Integer
        Try
            If Validar(oeCliente) Then
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function Listar(ByVal oeCliente As e_Cliente) As System.Collections.Generic.List(Of e_Cliente) Implements Il_Cliente.Listar
        Try
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function Obtener(ByVal oeCliente As e_Cliente) As e_Cliente Implements Il_Cliente.Obtener
        Try
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function ObtenerId(ByVal id As String) As e_Cliente Implements Il_Cliente.ObtenerId
        Try
    ...
    Public Function Validar(ByVal oeCliente As e_Cliente) As Boolean Implements Il_Cliente.Validar
        Try
            With oeCliente
