...
Public Class l_CalculaTiempoServicio
    ...
    Public Function Obtener(ByVal oeCalculaTiempoServicio As EntidadesWCF.e_CalculaTiempoServicio) As EntidadesWCF.e_CalculaTiempoServicio Implements Il_CalculaTiempoServicio.Obtener
        Try
