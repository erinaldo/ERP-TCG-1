...
Public Class l_PeajeTarifa
    ...
    Public Function Eliminar(oePeajeTarifa As EntidadesWCF.e_PeajeTarifa) As Boolean Implements Il_PeajeTarifa.Eliminar
        Try
    ...
    Public Function Guardar(oePeajeTarifa As EntidadesWCF.e_PeajeTarifa) As Boolean Implements Il_PeajeTarifa.Guardar
        Try
            odPeajeTarifa = New d_PeajeTarifa
    ...
    Public Function Listar(oePeajeTarifa As EntidadesWCF.e_PeajeTarifa) As List(Of EntidadesWCF.e_PeajeTarifa) Implements Il_PeajeTarifa.Listar
        Try
            odPeajeTarifa = New d_PeajeTarifa
    ...
    Public Function Obtener(oePeajeTarifa As EntidadesWCF.e_PeajeTarifa) As EntidadesWCF.e_PeajeTarifa Implements Il_PeajeTarifa.Obtener
        Try
            odPeajeTarifa = New d_PeajeTarifa
