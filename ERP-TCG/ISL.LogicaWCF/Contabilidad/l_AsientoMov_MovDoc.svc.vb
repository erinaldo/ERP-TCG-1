...
Public Class l_AsientoMov_MovDoc
    ...
    Public Function Eliminar(ByVal oeAsientoMov_MovDoc As EntidadesWCF.e_AsientoMov_MovDoc) As Boolean Implements Il_AsientoMov_MovDoc.Eliminar
        Try
    ...
    Public Function Guardar(ByVal oeAsientoMov_MovDoc As EntidadesWCF.e_AsientoMov_MovDoc) As Boolean Implements Il_AsientoMov_MovDoc.Guardar
        Try
    ...
    Public Function Listar(ByVal oeAsientoMov_MovDoc As EntidadesWCF.e_AsientoMov_MovDoc) As System.Collections.Generic.List(Of EntidadesWCF.e_AsientoMov_MovDoc) Implements Il_AsientoMov_MovDoc.Listar
        Try
    ...
    Public Function Obtener(ByVal oeAsientoMov_MovDoc As EntidadesWCF.e_AsientoMov_MovDoc) As EntidadesWCF.e_AsientoMov_MovDoc Implements Il_AsientoMov_MovDoc.Obtener
        Try
    ...
    Public Function Validar(ByVal oeAsientoMov_MovDoc As EntidadesWCF.e_AsientoMov_MovDoc) As Boolean Implements Il_AsientoMov_MovDoc.Validar
        Try
