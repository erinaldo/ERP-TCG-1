...
Public Class l_DetallePlanillaPiloto
    ...
    Public Function Listar(oe As EntidadesWCF.e_DetallePlanillaPiloto) As List(Of EntidadesWCF.e_DetallePlanillaPiloto) Implements Il_DetallePlanillaPiloto.Listar
        Try
            Return od.Listar(oe)
