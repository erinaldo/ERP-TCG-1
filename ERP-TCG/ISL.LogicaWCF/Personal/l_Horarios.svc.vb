' NOTA: puede usar el comando "Cambiar nombre" del menú contextual para cambiar el nombre de clase "l_Horarios" en el código, en svc y en el archivo de configuración a la vez.
