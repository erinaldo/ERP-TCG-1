...
Public Class l_Accidente
    ...
    Public Function Eliminar(ByVal oeAccidente As e_Accidente) As Boolean Implements Il_Accidente.Eliminar
        Try
    ...
    Public Function Guardar(ByVal oeAccidente As e_Accidente) As Boolean Implements Il_Accidente.Guardar
        Try
    ...
    Public Function Listar(ByVal oeAccidente As e_Accidente) As System.Collections.Generic.List(Of e_Accidente) Implements Il_Accidente.Listar
        Try
    ...
    Public Function Obtener(ByVal oeAccidente As e_Accidente) As e_Accidente Implements Il_Accidente.Obtener
        Try
    ...
    Public Function Validar(ByVal oeAccidente As e_Accidente) As Boolean Implements Il_Accidente.Validar
        Try
            With oeAccidente
