...
Public Class l_ChequeDocumento
    ...
    Public Function Eliminar(oe As e_ChequeDocumento) As Boolean Implements Il_ChequeDocumento.Eliminar
        Try
    ...
    Public Function Guardar(oe As e_ChequeDocumento) As Boolean Implements Il_ChequeDocumento.Guardar
        Try
    ...
    Public Function Listar(oe As e_ChequeDocumento) As List(Of e_ChequeDocumento) Implements Il_ChequeDocumento.Listar
        Try
