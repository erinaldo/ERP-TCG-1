...
Public Class l_ChequexCobrar
    ...
    Public Function Eliminar(ByVal oeChequexCobrar As EntidadesWCF.e_ChequexCobrar) As Boolean Implements Il_ChequexCobrar.Eliminar
        Try
    ...
    Public Function Guardar(ByVal oeChequexCobrar As EntidadesWCF.e_ChequexCobrar) As Boolean Implements Il_ChequexCobrar.Guardar
        Try
    ...
    Public Function Listar(ByVal oeChequexCobrar As EntidadesWCF.e_ChequexCobrar) As System.Collections.Generic.List(Of EntidadesWCF.e_ChequexCobrar) Implements Il_ChequexCobrar.Listar
        Try
    ...
    Public Function Obtener(ByVal oeChequexCobrar As EntidadesWCF.e_ChequexCobrar) As EntidadesWCF.e_ChequexCobrar Implements Il_ChequexCobrar.Obtener
        Try
    ...
    Public Function Validar(ByVal oeChequexCobrar As EntidadesWCF.e_ChequexCobrar) As Boolean Implements Il_ChequexCobrar.Validar
        Try
