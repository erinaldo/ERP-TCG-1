...
Public Class frm_PagoAdicional
...
#Region "Instancia"
    ...
    Private Shared instancia As frm_PagoAdicional = Nothing
    Private Shared Operacion As String

    Public Overrides Function getInstancia() As frm_MenuPadre
        If instancia Is Nothing Then
            Operacion = "Inicializa"
            instancia = New frm_PagoAdicional()
        End If
        instancia.Activate()
        Return instancia
    End Function
...
#Region "Declaracion de Variables"
    ...
    Private oePagoAdicional As New e_PagoAdicional, olPagoAdicional As New l_PagoAdicional, lePagoAdicional As New List(Of e_PagoAdicional)
    Private oeEstado As New e_Estado, olEstado As New l_Estado, leEstado As New List(Of e_Estado)
    Private oeDetalle As New e_DetallePagoAdicional, olDetalle As New l_DetallePagoAdicional
    Private leDetalle As New List(Of e_DetallePagoAdicional), leDetImportar As New List(Of e_DetallePagoAdicional)
    ...
    Private oePAAuxiliar As New e_PagoAdicional
    Private loConcepto As New l_Concepto
    Private oeConcepto As New e_Concepto
    Private ListaConcepto As New List(Of e_Concepto)
    ...
    Public Overrides Sub Nuevo()
        Try
            ...
            If ValidarAcl(_acl, pIdActividadNegocio) Then
                _opePA = "GENERADA"
                oePagoAdicional = New e_PagoAdicional
                oePagoAdicional.TipoOperacion = "I"
                oePagoAdicional.Activo = True
                Inicializa()
    ...
    Public Overrides Sub Editar()
        Try
            ...
            If ValidarAcl(_acl, pIdActividadNegocio) Then
                ...
                Mostrar()
                oePagoAdicional.TipoOperacion = "A"
        ...
        Try
            Select Case _opePA
                ...
                Case "ENVIAR"
                    ...
                    oePagoAdicional.PrefijoID = gs_PrefijoIdSucursal '@0001
                    If olPagoAdicional.Guardar(oePagoAdicional) Then
                        mensajeEmergente.Confirmacion("¡El Registro de Pagos Adicionales Nº: " & oePagoAdicional.Codigo &
                ...
                Case "IMPORTAR"
                    ...
                    If _leAux.Count > 0 Then
                        ...
                        'Else
                        oePagoAdicional = New e_PagoAdicional
                        oePagoAdicional.TipoOperacion = ""
                        oePagoAdicional.IdPlanilla = cboPlanillaDI.Value
                        oePagoAdicional.Activo = True
                        oePagoAdicional = olPagoAdicional.Obtener(oePagoAdicional)
                        If oePagoAdicional IsNot Nothing AndAlso oePagoAdicional.Id.Trim <> "" Then
                            oePagoAdicional.TipoOperacion = "A"
                            oePagoAdicional.UsuarioModifica = gUsuarioSGI.Id
                            oePagoAdicional.leDetalle = New List(Of e_DetallePagoAdicional)
                            oePagoAdicional.leDetalle = _leAux
                        Else
                            oePagoAdicional.TipoOperacion = "I"
                            oePagoAdicional.IdPlanilla = cboPlanillaDI.Value
                            oePagoAdicional.UsuarioCreacion = gUsuarioSGI.Id
                            oePagoAdicional.Codigo = fn_ObtenerCodigo()
                            oePagoAdicional.Descripcion = txtGlosa.Text
                            ...
                            oePagoAdicional.leDetalle = _leAux
                        End If
                        If olPagoAdicional.ImportarDatos(oePagoAdicional) Then
...
#Region "Eventos"
    ...
    Private Sub frm_PagoAdicional_Activated(sender As Object, e As EventArgs) Handles Me.Activated

    End Sub

    Private Sub frm_PagoAdicional_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        instancia = Nothing
    End Sub

    Private Sub frm_PagoAdicional_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            SeleccionaTab(0)
            CargarCombos()
            lePagoAdicional = New List(Of e_PagoAdicional)
            CargarPagoAdicional(lePagoAdicional)
        Catch ex As Exception
            mensajeEmergente.Problema(ex.Message, True)
        End Try
    End Sub
    ...
    Private Sub cboPlanilla_ValueChanged(sender As Object, e As EventArgs) Handles cboPlanilla.ValueChanged
        Try
            If cboPlanilla.SelectedIndex > -1 Then
                ...
                If oePagoAdicional.TipoOperacion = "I" Then
                    Dim oePA As New e_PagoAdicional
                    oePA.TipoOperacion = ""
                    oePA.IdPlanilla = _oeplaaux.id
                    oePA.Activo = True
                    oePA = olPagoAdicional.Obtener(oePA)
                    If oePA.Id <> "" Then
    ...
    Private Sub btnCargar_Click(sender As Object, e As EventArgs) Handles btnCargar.Click
        Try
            If cboPlanilla.SelectedIndex > -1 Then
                'leDetalle = New List(Of e_DetallePagoAdicional)
                ...
                If leResumenAsist.Count > 0 Then
                    ...
                    For Each oeRA In leResumenAsist
                        oeDetalle = New e_DetallePagoAdicional
                        ...
                        oeDetalle.Cantidad = oeRA.Cantidad
                ...
                If MessageBox.Show("¿Desar Agregar los Registros?", "Mensaje de Sistema", _
                    ...
                    For Each oeAux In leDetalle
                        ...
                        If _rwAux.Count > 0 Then
                            ...
                            oeAux.Sueldo = _dsFila.Rows(0).Item("SUELDO")
                            oeAux.DiasDescanso = _dsFila.Rows(0).Item("DIAS_DESC")
                            oeAux.DiasFalta = _dsFila.Rows(0).Item("DIAS_FALTA")
                            oeAux.DiasVacaciones = _dsFila.Rows(0).Item("DIAS_VACAC")
                            If _dsFila.Rows(0).Item("ASIG_FAM") = 1 Then oeAux.AsignacionFamiliar = _af
                        Else
            ...
            If cboTipoDI.SelectedIndex > -1 Then
                If oePAAuxiliar.Id <> "" Then
                    If oePAAuxiliar.leDetalle.Count > 0 Then
                        Dim _leAux = oePAAuxiliar.leDetalle.Where(Function(it) it.IndTipo = cboTipoDI.SelectedIndex).ToList
                        If _leAux.Count > 0 Then
...
#Region "Metodos"
    ...
    Private Sub CargarCombos()
        Try
            ...
            oeConcepto.Prefijo = "27"
            ListaConcepto = loConcepto.Listar(oeConcepto).OrderBy(Function(x) x.Nombre).ToList
            ...
            'cboTipoDI.Items.Add(0, "HORAS EXTRAS 25%")
            'cboTipoDI.Items.Add(1, "HORAS EXTRAS 35%")
            'cboTipoDI.Items.Add(2, "HORARIO NOCTURNO")
            'cboTipoDI.Items.Add(3, "BONO POR ALIMENTACIÓN")
            'cboTipoDI.Items.Add(4, "SUBSIDIOS")
            'cboTipoDI.Items.Add(5, "SEMÁFORO")
            'cboTipoDI.Items.Add(6, "MOVILIDAD (CALIZA)")
            'cboTipoDI.Items.Add(7, "SUBSIDIOS (MATERNIDAD)")
            'cboTipoDI.SelectedIndex = -1
            ...
            'cboTipoIngreso.Items.Add(0, "HORAS EXTRAS 25%")
            'cboTipoIngreso.Items.Add(1, "HORAS EXTRAS 35%")
            'cboTipoIngreso.Items.Add(2, "HORARIO NOCTURNO")
            'cboTipoIngreso.Items.Add(3, "BONO POR ALIMENTACIÓN")
            'cboTipoIngreso.Items.Add(4, "SUBSIDIOS")
            'cboTipoIngreso.Items.Add(5, "SEMÁFORO")
            'cboTipoIngreso.Items.Add(6, "MOVILIDAD (CALIZA)")
            'cboTipoIngreso.Items.Add(7, "SUBSIDIOS (MATERNIDAD)")
            'cboTipoIngreso.SelectedIndex = -1
    ...
    Private Sub CargarPagoAdicional(lePagoAdic As List(Of e_PagoAdicional))
        Try
    ...
    Private Sub Listar()
        Try
            ...
            oePagoAdicional.TipoOperacion = ""
            oePagoAdicional.Activo = True
            If cboPlanillaBus.SelectedIndex > -1 Then oePagoAdicional.IdPlanilla = cboPlanillaBus.Value
            oePagoAdicional.IdEstado = cboEstadoBus.Value
            lePagoAdicional = olPagoAdicional.Listar(oePagoAdicional)
            CargarPagoAdicional(lePagoAdicional)
        Catch ex As Exception
            Throw ex
        End Try
    ...
    Private Function fn_ObtenerCodigo() As String
        Try
            Dim str As String = ""
            Dim oePagoAdi As New e_PagoAdicional
            oePagoAdi.TipoOperacion = "U"
            oePagoAdi = olPagoAdicional.Obtener(oePagoAdi)
    ...
    Private Sub Mostrar()
        Try
            oePagoAdicional = New e_PagoAdicional
            oePagoAdicional.TipoOperacion = ""
            oePagoAdicional.Id = griPagoAdicional.ActiveRow.Cells("Id").Value
            oePagoAdicional = olPagoAdicional.Obtener(oePagoAdicional)
    ...
    Private Sub ConfiguraGrilla(Grilla As UltraGrid, Tipo As Integer)
        Try
            With Grilla
                ...
                OcultarColumna(Grilla, True, "Id", "IdPagoAdicional", "IdTrabajador", "IndTipo", "FechaCreacion", "UsuarioCreacion", _
                               "FechaModifica", "UsuarioModifica", "Activo", "DiasVacaciones", "DiasDescanso", "DiasFalta", "TotalDias")
                ExcluirColumna(Grilla, "Id", "IdPagoAdicional", "IdTrabajador", "IndTipo", "FechaCreacion", "UsuarioCreacion", _
                              "FechaModifica", "UsuarioModifica", "Activo", "DiasVacaciones", "DiasDescanso", "DiasFalta", "TotalDias")
                ...
                FormatoColumna(Grilla, "", ColumnStyle.Default, HAlign.Center, "Cantidad", "DiasFalta", "DiasVacaciones", "DiasDescanso", "TotalDias")
                ...
                .DisplayLayout.Bands(0).Columns("DiasFalta").Header.Caption = "D.F."
                .DisplayLayout.Bands(0).Columns("DiasVacaciones").Header.Caption = "D.V."
                .DisplayLayout.Bands(0).Columns("DiasDescanso").Header.Caption = "D.D."
    ...
    Private Sub Cargar25Ext(leDet As List(Of e_DetallePagoAdicional))
        Try
            With griHora25
                .ResetDisplayLayout()
                Dim _leAux = leDet.Where(Function(it) it.Activo = True And it.IndTipo = 0).ToList
                .DataSource = _leAux
                ConfiguraGrilla(griHora25, 1)
            End With
        Catch ex As Exception
            Throw ex
        End Try
    ...
    Private Sub Cargar35Ext(leDet As List(Of e_DetallePagoAdicional))
        Try
            With griHora35
                .ResetDisplayLayout()
                Dim _leAux = leDet.Where(Function(it) it.Activo = True And it.IndTipo = 1).ToList
                .DataSource = _leAux
                ConfiguraGrilla(griHora35, 2)
            End With
        Catch ex As Exception
            Throw ex
        End Try
    ...
    Private Sub CargarNocturna(leDet As List(Of e_DetallePagoAdicional))
        Try
            With griNocturno
                .ResetDisplayLayout()
                Dim _leAux = leDet.Where(Function(it) it.Activo = True And it.IndTipo = 2).ToList
                .DataSource = _leAux
                ConfiguraGrilla(griNocturno, 2)
            End With
        Catch ex As Exception
            Throw ex
        End Try
    ...
    Private Sub CargarOtros(leDet As List(Of e_DetallePagoAdicional))
        Try
            With griOtros
                .ResetDisplayLayout()
                'Dim _leAux = leDet.Where(Function(it) it.Activo = True And it.IndTipo > 2).ToList
    ...
    Private Sub RecolectaDatos()
        oePagoAdicional.Codigo = txtCodigo.Text
        oePagoAdicional.IdEstado = cboEstado.Value
        oePagoAdicional.IdPlanilla = cboPlanilla.Value
        oePagoAdicional.Descripcion = txtGlosa.Text
        oePagoAdicional.leDetalle = leDetalle
    End Sub

    Private Sub CargarDetImportar(leDI As List(Of e_DetallePagoAdicional))
        Try
            With griImportar
...
#Region "Menu Contextual"
    ...
    Private Sub mcPagoAdicional_Opening(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles mcPagoAdicional.Opening
