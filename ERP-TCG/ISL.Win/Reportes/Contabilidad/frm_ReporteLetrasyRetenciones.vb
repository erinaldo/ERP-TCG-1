Public Class frm_ReporteLetrasyRetenciones
    Inherits frm_ReporteBasico

    Private Shared instancia As frm_ReporteLetrasyRetenciones = Nothing
...
#Region "Inicializar formulario"
    ...
    '        instancia = New frm_ReporteLetrasyRetenciones()
    '    End If
    '    instancia.Activate()
    '    Return instancia
    'End Function
...
#End Region
    ...
    Private Sub CargarDatos()
        Try
            Me.Text = "Reporte de Letras y Retenciones"
            CargarReporteRemoto("/Reportes/", "FIN - Reporte Letras y Retenciones")
