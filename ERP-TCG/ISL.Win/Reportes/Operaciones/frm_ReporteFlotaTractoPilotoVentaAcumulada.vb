...
Public Class frm_ReporteFlotaTractoPilotoVentaAcumulada
...
#Region "Inicializar formulario"
    ...
    Private Shared instancia As frm_ReporteFlotaTractoPilotoVentaAcumulada = Nothing

    Public Overrides Function getInstancia() As frm_MenuPadre
        If instancia Is Nothing Then
            instancia = New frm_ReporteFlotaTractoPilotoVentaAcumulada()
        End If
        instancia.Activate()
        Return instancia
    End Function
