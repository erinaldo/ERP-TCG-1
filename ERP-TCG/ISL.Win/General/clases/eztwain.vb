...
'
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_Testing123")> _
...
'--------- Top-Level Calls
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_ResetAll")> _
...
' before starting a sequence of scanning calls.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_Acquire")> _
...
'     if (hdib) then ... process image, TWAIN_FreeNative(hdib); end
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SelectImageSource")> _
...
' current default source, after calling SelectImageSource, or any other time.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_AcquireToFilename")> _
...
' -10  user cancelled File Save dialog
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_AcquireMultipageFile")> _
...
' endlessly (until disk full.)
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_AcquireToArray")> _
...
' In case of error, no images are returned - the scan must be restarted.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_AcquireImagesToFiles")> _
...
'           TWAIN_BlankDiscardCount.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_AcquirePagesToFiles")> _
...
' details available from TWAIN_LastErrorCode & related functions.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_AcquireMultipage")> _
...
' each image.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_AcquiredFileCount")> _
...
' AcquireImagesToFiles or AcquirePagesToFiles.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_AcquireCompressed")> _
...
' Call this function (possibly in a loop) to acquire images.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_AcquireCount")> _
...
' Therefore it may differ from the value of TWAIN_MultipageCount.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_PromptToContinue")> _
...
' Also Russian and Japanese, but those may not work....
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetDefaultScanAnotherPagePrompt")> _
...
' Return value: Previous value of the setting.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_DoSettingsDialog")> _
...
'          ReportLastError, or similar function for more details.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_EnableSourceUiOnly")> _
...
'--------- Global Options
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetMultiTransfer")> _
        Public Shared Sub SetMultiTransfer(ByVal bYes As Boolean)
        End Sub
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetMultiTransfer")> _
...
' See also: TWAIN_UserClosedSource()
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetHideUI")> _
        Public Shared Sub SetHideUI(ByVal bHide As Boolean)
        End Sub
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetHideUI")> _
...
' See also: HasControllableUI
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetStopOnEmpty")> _
        Public Shared Sub SetStopOnEmpty(ByVal bYes As Boolean)
        End Sub
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetStopOnEmpty")> _
...
' scanning to stop when everything in the feeder has been scanned.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_DisableParent")> _
        Public Shared Sub DisableParent(ByVal bYes As Boolean)
        End Sub
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetDisableParent")> _
...
'--------- Basic TWAIN Inquiries
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_EasyVersion")> _
...
' So e.g. version 2.01 will return 201 from this call.
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_EasyBuild")> _
        Public Shared Function EasyBuild() As Int32
        End Function
' Returns the build number within the version.

        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_IsAvailable")> _
...
' installed & can be loaded, 0 otherwise. 
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_IsMultipageAvailable")> _
...
' It also enables TWAIN_AcquireMultipageFile
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_State")> _
...
' Returns the TWAIN Protocol State per the spec.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_IsDone")> _
...
'
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SourceName")> _
...
' source has been used and then closed.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetSourceName")> _
...
'--------- DIB handling utilities ---------
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False)> _
...
' Return the number of available printers
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="DIB_PrinterName")> _
...
' default settings - the user is not prompted.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_PrintFile")> _
...
'--- OBSOLETE: The following functions are for backward compatibility only:
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_WriteNativeToFilename")> _
        Public Shared Function WriteNativeToFilename(ByVal hdib As IntPtr, ByVal sFileName As String) As Int32
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_LoadNativeFromFilename")> _
...
' removed - contact Dosadi if this causes problems for you.
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_NegotiateXferCount")> _
        Public Shared Function NegotiateXferCount(ByVal nXfers As Int32) As Int32
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_DibDepth")> _
        Public Shared Function DibDepth(ByVal hdib As IntPtr) As Int32
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_DibWidth")> _
        Public Shared Function DibWidth(ByVal hdib As IntPtr) As Int32
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_DibHeight")> _
        Public Shared Function DibHeight(ByVal hdib As IntPtr) As Int32
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_DibNumColors")> _
        Public Shared Function DibNumColors(ByVal hdib As IntPtr) As Int32
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_DibRowBytes")> _
        Public Shared Function DibRowBytes(ByVal hdib As IntPtr) As Int32
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_DibReadRow")> _
        Public Shared Sub DibReadRow(ByVal hdib As IntPtr, ByVal nRow As Int32, ByRef prow As System.Byte)
        End Sub
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_CreateDibPalette")> _
        Public Shared Function CreateDibPalette(ByVal hdib As IntPtr) As IntPtr
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_DrawDibToDC")> _
...
' modified since the last operation that cleared the Modified flag.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="DOC_Filename")> _
...
' Note: BMP support is built into EZTwain, so is always available.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_IsJpegAvailable")> _
...
' Returns 0 if JPEG support has not been installed.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_IsPngAvailable")> _
        Public Shared Function IsPngAvailable() As Boolean
        End Function
' Return TRUE (1) if PNG format support is available.

        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_IsTiffAvailable")> _
        Public Shared Function IsTiffAvailable() As Boolean
        End Function
' Return TRUE (1) if TIFF format support is available.

        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_IsPdfAvailable")> _
        Public Shared Function IsPdfAvailable() As Boolean
        End Function
' Return TRUE (1) if PDF format support is available.

        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_IsGifAvailable")> _
        Public Shared Function IsGifAvailable() As Boolean
        End Function
' Return TRUE (1) if GIF format support is available.

        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_IsDcxAvailable")> _
...
' B&W images - EZTwain converts the image data as needed.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_IsFormatAvailable")> _
...
' the necessary DLLs.  See the 
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_FormatVersion")> _
        Public Shared Function FormatVersion(ByVal nFF As Int32) As Int32
        End Function
' Return the format module version * 100.

        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_IsFileExtensionAvailable")> _
...
' Case does not matter, leading '.' is optional.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_FormatFromExtension")> _
...
' Case does not matter, leading '.' is optional.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_ExtensionFromFormat")> _
...
' If nFF is not a valid value, returns its second parameter.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetExtensionFromFormat")> _
...
' If the file format is not recognized, returns the value of the 2nd parameter.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetSaveFormat")> _
        Public Shared Function SetSaveFormat(ByVal nFF As Int32) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetSaveFormat")> _
...
' by some versions of EZTWAIN, or require external DLLs be installed.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetJpegQuality")> _
        Public Shared Sub SetJpegQuality(ByVal nQ As Int32)
        End Sub
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetJpegQuality")> _
...
'- Special TIFF options ------------------------------------------
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetTiffStripSize")> _
        Public Shared Sub SetTiffStripSize(ByVal nBytes As Int32)
        End Sub
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetTiffStripSize")> _
...
' Default value = 32768 (subject to change, in theory.)
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetTiffImageDescription")> _
        Public Shared Function SetTiffImageDescription(ByVal sText As String) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetTiffDocumentName")> _
...
' once the file is closed.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetTiffCompression")> _
        Public Shared Function SetTiffCompression(ByVal nPT As Int32, ByVal nComp As Int32) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetTiffCompression")> _
...
' Setting TIFF tags explicitly, including custom/private tags:
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetTiffTagShort")> _
        Public Shared Function SetTiffTagShort(ByVal nTagId As Int32, ByVal sValue As Int32) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetTiffTagLong")> _
        Public Shared Function SetTiffTagLong(ByVal nTagId As Int32, ByVal nValue As Int32) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetTiffTagString")> _
        Public Shared Function SetTiffTagString(ByVal nTagId As Int32, ByVal sText As String) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetTiffTagDouble")> _
        Public Shared Function SetTiffTagDouble(ByVal nTagId As Int32, ByVal dValue As Double) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetTiffTagRational")> _
        Public Shared Function SetTiffTagRational(ByVal nTagId As Int32, ByVal dValue As Double) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetTiffTagRationalArray")> _
        Public Shared Function SetTiffTagRationalArray(ByVal nTagId As Int32, ByVal dValues As Double(), ByVal n As Int32) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetTiffTagBytes")> _
        Public Shared Function SetTiffTagBytes(ByVal nTagId As Int32, ByRef pdata As System.Byte, ByVal nBytes As Int32) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetTiffTagUndefined")> _
...
' define it to EZTwain - see TWAIN_DefineCustomTiffTag, below.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_ResetTiffTags")> _
...
' signed or unsigned as needed by the specific tag.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetTiffTagAscii")> _
...
' Returns True(1) if successful, False(0) otherwise.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_TiffTagAscii")> _
...
' or call TWAIN_LastErrorCode and related functions.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetFileAppendFlag")> _
        Public Shared Sub SetFileAppendFlag(ByVal bAppend As Boolean)
        End Sub
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetFileAppendFlag")> _
...
' Dosadi PDF module.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="PDF_DocumentProperty")> _
...
' These functions configure or add information to the next output PDF file:
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetPdfTitle")> _
        Public Shared Function SetPdfTitle(ByVal sText As String) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetPdfAuthor")> _
        Public Shared Function SetPdfAuthor(ByVal sText As String) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetPdfSubject")> _
        Public Shared Function SetPdfSubject(ByVal sText As String) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetPdfKeywords")> _
        Public Shared Function SetPdfKeywords(ByVal sText As String) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetPdfCreator")> _
...
'---------------------------------------------------------
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_WriteToFilename")> _
...
' This is the same as DIB_WriteToFilename - please refer to that function.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_LoadFromFilename")> _
...
' Returns a DIB handle if successful, otherwise NULL.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_LoadPage")> _
...
' formats have a single page, page #0.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_FormatOfFile")> _
...
' A return value < 0 means 'unrecognized format'.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_PagesInFile")> _
...
' this function records an error and returns -1.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_PromptForOpenFilename")> _
...
'--------- File View Dialog
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_ViewFile")> _
...
' -2   error displaying dialog, opening file, etc.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetViewOption")> _
...
' reset                                                                                               ...                                                                 setting this option resets all options to default value.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_IsViewOpen")> _
        Public Shared Function IsViewOpen() As Boolean
        End Function
' Return True if the viewer window is open, False otherwise.

        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_ViewClose")> _
...
' Returns True(1) if it closed the viewer window, False(0) otherwise.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetLastViewPosition")> _
...
'--------- Multipage File Output
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetMultipageFormat")> _
        Public Shared Function SetMultipageFormat(ByVal nFF As Int32) As Int32
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetMultipageFormat")> _
...
' -3 = format is currently unavailable (missing/bad DLL)
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetLazyWriting")> _
        Public Shared Sub SetLazyWriting(ByVal bYes As Boolean)
        End Sub
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetLazyWriting")> _
...
'  -7  multipage support is not installed.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_BeginMultipageFile")> _
...
'  -7  Multipage support is not installed.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_DibWritePage")> _
...
'  -7  Multipage support is not installed.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_WritePageAndFree")> _
...
' without making a copy of the image.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_EndMultipageFile")> _
...
'  -7  Multipage support is not installed.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_MultipageCount")> _
...
' which is reset by BeginMultipageFile, and is incremented by DibWritePage.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_IsMultipageFileOpen")> _
...
' Only one multipage output file can be open at a time (per process.)
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_LastOutputFile")> _
...
' DIB_WriteToFilename or TWAIN_AcquireToFilename, etc.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetOutputPageCount")> _
...
' to TIFF files.  You can use nPages=0, which means "I don't know".
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_FileCopy")> _
...
' -126    could not open/read local file
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="UPLOAD_Response")> _
...
'--------- Application Registration and Licensing
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetAppTitle")> _
...
' including TIFF.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetApplicationKey")> _
...
' the application title (product name) passed to one of those functions.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_ApplicationLicense")> _
...
' Unlock EZTwain using a Single Application License.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetVendorKey")> _
...
' Unlock EZTwain using a Universal Application / Vendor License
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_OrganizationLicense")> _
...
' Unlock EZTwain using an Organization / In-House Application License.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_RenewTrialLicense")> _
...
' Contact Dosadi Support (support@dosadi.com) for such a key.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SingleMachineLicense")> _
...
' FALSE if EZTwain Pro is not licensed for use on this computer.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_RegisterApp")> _
...
' EZTwain Error codes
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetResultCode")> _
        Public Shared Function GetResultCode() As Int32
        End Function
' Return the result code (TWRC_xxx) from the last triplet sent to TWAIN

        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetConditionCode")> _
...
' If a source is NOT open, return the condition code of the source manager.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_UserClosedSource")> _
...
' MSG_CLOSEDSREQ message through TWAIN.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_ErrorBox")> _
...
' If messages are suppressed (see below) this function does nothing.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SuppressErrorMessages")> _
...
' EZTWAIN cannot suppress messages from TWAIN or TWAIN device drivers.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_ReportLastError")> _
...
' not it displays a message, by calling TWAIN_ClearError.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetLastErrorText")> _
...
' in the string variable before calling this function.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_LastErrorText")> _
...
' see Notes for TWAIN_GetLastErrorText.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_LastErrorCode")> _
        Public Shared Function LastErrorCode() As Int32
        End Function
' Return the last internal EZTWAIN error code. (see EZTEC_ codes above)

        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_ClearError")> _
        Public Shared Sub ClearError()
        End Sub
' Set the EZTWAIN internal error code to EZTEC_NONE

        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_RecordError")> _
...
' functions also clear it.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_ReportLeaks")> _
...
'--------- TWAIN State Control ------------------------------------
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_Shutdown")> _
...
' TWAIN is closed and unloaded.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_LoadSourceManager")> _
...
' if TWAIN.DLL has been corrupted.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_OpenSourceManager")> _
...
' This call will fail if the Source Manager is not loaded.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_OpenDefaultSource")> _
...
' These two functions allow you to enumerate the available data sources:
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetSourceList")> _
...
' this function returns TRUE(1) if there was no other error.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetNextSourceName")> _
...
' Returns TRUE (1) if successful, FALSE (0) if there are no more.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_NextSourceName")> _
...
' Returns the empty string when it comes to the end of the list.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetDefaultSourceName")> _
...
' in the string variable before calling this function.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_DefaultSourceName")> _
...
' Like GetDefaultSourceName but returns a string
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_OpenSource")> _
...
' Will load and open the Source Manager if needed.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_EnableSource")> _
...
' this call does nothing and returns TRUE.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_DisableSource")> _
...
' If successful or the source is already disabled, returns TRUE(1).
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_CloseSource")> _
...
' If successful or source is already closed, returns TRUE(1).
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_CloseSourceManager")> _
...
' If successful (or if source manager is already closed) returns TRUE(1).
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_UnloadSourceManager")> _
...
' If successful, it returns TRUE(1)
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_IsTransferReady")> _
        Public Shared Function IsTransferReady() As Boolean
        End Function

        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_EndXfer")> _
        Public Shared Function EndXfer() As Boolean
        End Function

        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_AbortAllPendingXfers")> _
...
' These functions should only be called in State 4 (TWAIN_SOURCE_OPEN)
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetXferCount")> _
...
' TWAIN unit codes (from twain.h)
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetCurrentUnits")> _
...
' There is no error return - in case of error it returns 0 (TWUN_INCHES)
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetUnits")> _
        Public Shared Function SetUnits(ByVal nUnits As Int32) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetCurrentUnits")> _
...
' 3. Ditto (same comment) for ImageLayout, see below.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetBitDepth")> _
...
' If anything goes wrong, this function returns 0.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetBitDepth")> _
...
'------- TWAIN Pixel Types (from twain.h)
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetPixelType")> _
...
' If anything goes wrong (it shouldn't), this function returns 0 (TWPT_BW).
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetPixelType")> _
        Public Shared Function SetPixelType(ByVal nPixType As Int32) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetCurrentPixelType")> _
...
' The source may select this pixel type, but don't assume it will.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetCurrentResolution")> _
...
' If anything goes wrong (it shouldn't) this function returns 0.0
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetXResolution")> _
        Public Shared Function GetXResolution() As Double
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetYResolution")> _
...
' In the event of failure, returns 0.0.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetResolution")> _
        Public Shared Function SetResolution(ByVal dRes As Double) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetResolutionInt")> _
        Public Shared Function SetResolutionInt(ByVal nRes As Int32) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetCurrentResolution")> _
...
' device can handle this:
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetXResolution")> _
        Public Shared Function SetXResolution(ByVal dxRes As Double) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetYResolution")> _
        Public Shared Function SetYResolution(ByVal dyRes As Double) As Boolean
        End Function

        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetContrast")> _
...
' The TWAIN standard *says* that the range for this cap is -1000 ... +1000
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetBrightness")> _
        Public Shared Function SetBrightness(ByVal dBri As Double) As Boolean
        End Function
' Try to set the current brightness for acquisition.
' The TWAIN standard *says* that the range for this cap is -1000 ... +1000

        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetThreshold")> _
...
' that for 8-bit samples, values >= nThresh are thresholded to 1, others to 0.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetCurrentThreshold")> _
...
'
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetAutoDeskew")> _
...
'  1   - auto deskew using EZTwain software algorithms
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetAutoDeskew")> _
...
'
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetBlankPageMode")> _
        Public Shared Sub SetBlankPageMode(ByVal nMode As Int32)
        End Sub
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetBlankPageMode")> _
...
' See TWAIN_SetBlankPageThreshold below for more details.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetBlankPageThreshold")> _
        Public Shared Sub SetBlankPageThreshold(ByVal dDarkness As Double)
        End Sub
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetBlankPageThreshold")> _
...
' The default BlankPageThreshold is 0.02 (= 2% dark pixels).
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_BlankDiscardCount")> _
...
'
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetAutoCrop")> _
        Public Shared Sub SetAutoCrop(ByVal nMode As Int32)
        End Sub
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetAutoCrop")> _
...
'  3   - use scanner autocrop if possible, otherwise do software autocrop.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetAutoCropOptions")> _
        Public Shared Sub SetAutoCropOptions(ByVal nOpts As Int32)
        End Sub
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetAutoCropOptions")> _
...
' See DIB_AutoCrop for details of these flags.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetAutoCropSize")> _
...
' To clear, use SetAutoCropSize(0,0) or call ClearAutoCropSize (below)
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_ClearAutoCropSize")> _
...
'
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetAutoContrast")> _
        Public Shared Sub SetAutoContrast(ByVal nMode As Int32)
        End Sub
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetAutoContrast")> _
...
'
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetAutoOCR")> _
        Public Shared Sub SetAutoOCR(ByVal nMode As Int32)
        End Sub
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetAutoOCR")> _
...
'
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetAutoNegate")> _
        Public Shared Sub SetAutoNegate(ByVal bYes As Boolean)
        End Sub
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetAutoNegate")> _
...
'--------------------------------------------------------------
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetXferMech")> _
        Public Shared Function SetXferMech(ByVal mech As Int32) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_XferMech")> _
...
'
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SupportsFileXfer")> _
...
' This mode is optional.  If TRUE, you can use AcquireFile.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetPaperSize")> _
...
' Note - These are synonyms for the TWSS_* constants in TWAIN.H
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetPaperDimensions")> _
...
'-------- Document Feeder -------
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_HasFeeder")> _
...
' Note: A FALSE(0) is returned if the source does not handle this inquiry.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_ProbablyHasFlatbed")> _
...
' It's a good guess but not a guarantee - we could be wrong.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_IsFeederSelected")> _
        Public Shared Function IsFeederSelected() As Boolean
        End Function
' Returns TRUE(1) if the document feeder is selected.

        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SelectFeeder")> _
...
' Returns TRUE(1) if successful, FALSE(0) otherwise.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_IsAutoFeedOn")> _
...
' Make sure the feeder is selected before calling this function.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetAutoFeed")> _
...
' Note: TWAIN_AcquireMultipageFile calls TWAIN_SetAutoFeed(True).
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_IsFeederLoaded")> _
        Public Shared Function IsFeederLoaded() As Boolean
        End Function
' Returns TRUE(1) if there are documents in the feeder.
' Make sure the feeder is selected before calling this function.

        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_IsPaperDetectable")> _
...
' Displays an error dialog if called with no scanner open.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetAutoScan")> _
...
'-------- Duplex Scanning -------
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetDuplexSupport")> _
...
' 2    = 2-pass duplex
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_EnableDuplex")> _
        Public Shared Function EnableDuplex(ByVal bYes As Boolean) As Boolean
        End Function
' Enable (bYes not 0) or disable (bYes=0) duplex scanning.
' Returns TRUE(1) if successful, FALSE(0) otherwise.

        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_IsDuplexEnabled")> _
...
'--------- Other 'exotic' capabilities --------
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_HasControllableUI")> _
...
' Return -1 if source (pre TWAIN 1.6) cannot answer the question.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetIndicators")> _
        Public Shared Function SetIndicators(ByVal bVisible As Boolean) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetIndicators")> _
...
' box or similar, but does not require it.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_Compression")> _
        Public Shared Function Compression() As Int32
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetCompression")> _
...
' Set returns TRUE(1) for success, FALSE(0) for failure.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_Tiled")> _
        Public Shared Function Tiled() As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetTiled")> _
...
' Set returns: TRUE(1) for success, FALSE(0) for failure.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_PlanarChunky")> _
        Public Shared Function PlanarChunky() As Int32
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetPlanarChunky")> _
...
' Set returns TRUE(1) for success, FALSE(0) for failure.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_PixelFlavor")> _
        Public Shared Function PixelFlavor() As Int32
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetPixelFlavor")> _
...
' Set returns: TRUE(1) for success, FALSE(0) for failure.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetLightPath")> _
...
' Returns: TRUE(1) for success, FALSE(0) for failure.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetAutoBright")> _
        Public Shared Function SetAutoBright(ByVal bOn As Boolean) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetGamma")> _
        Public Shared Function SetGamma(ByVal dGamma As Double) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetShadow")> _
        Public Shared Function SetShadow(ByVal d As Double) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetHighlight")> _
...
'--------- Image Layout (Region of Interest) --------
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetRegion")> _
...
' centimeters and the device is a camera whose only unit is pixels.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_ResetRegion")> _
        Public Shared Sub ResetRegion()
        End Sub
' Clear any region set with TWAIN_SetRegion above.

        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetImageLayout")> _
...
' from the top-left corner of the 'original page' (TWAIN 1.6 8-22)
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetImageLayout")> _
        Public Shared Function GetImageLayout(ByRef L As double, ByRef T As double, ByRef R As double, ByRef B As double) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetDefaultImageLayout")> _
...
' many DS's ignore ICAP_UNITS when dealing with Image Layout.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_ResetImageLayout")> _
...
' Closely related:
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetFrame")> _
...
'--------- Tone Response Curves --------
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetGrayResponse")> _
...
' Returns: TRUE(1) for success, FALSE(0) for failure.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetColorResponse")> _
...
' Returns: TRUE(1) for success, FALSE(0) for failure.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_ResetGrayResponse")> _
        Public Shared Function ResetGrayResponse() As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_ResetColorResponse")> _
...
' The Black Ice barcode engine must be separately licensed from Black Ice. 
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="BARCODE_EngineName")> _
...
' Barcode types:
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="BARCODE_TypeName")> _
...
'  -5                                                               internal error, or error from 3rd party barcode engine.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="BARCODE_Text")> _
...
' ----- OCR engines supported by EZTwain -----
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="OCR_EngineName")> _
...
' or call TWAIN_LastErrorCode and related functions.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="OCR_Text")> _
...
' Return the size in bytes of an item of the specified type (TWTY_*)
        ...
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="CONTAINER_StringValue")> _
...
' Getting a capability is valid in State 4 or any higher state.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_IsCapAvailable")> _
...
' Returns TRUE(1) if the capability can be queried, FALSE(0) if not.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_Get")> _
...
' or ReportLastError above.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetDefault")> _
        Public Shared Function GetDefault(ByVal uCap As Int32) As IntPtr
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetCurrent")> _
...
' Issue a DAT_CAPABILITY/MSG_GETDEFAULT or MSG_GETCURRENT.  See Get above.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_Set")> _
...
' Return value as for TWAIN_DS
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_Reset")> _
...
' State must be 4.  Returns TRUE(1) if successful, FALSE(0) otherwise.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_QuerySupport")> _
...
' A return < 0 indicates an error.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetCapability")> _
...
' (See TWAIN_ReportLastError.)
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetCapString")> _
...
' which itemType it wants.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetCapBool")> _
...
' Shorthand for TWAIN_SetCapOneValue(cap, TWTY_BOOL, bValue);
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetCapBool")> _
        Public Shared Function GetCapBool(ByVal cap As Int32, ByVal bDefault As Boolean) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetCapFix32")> _
        Public Shared Function GetCapFix32(ByVal cap As Int32, ByVal dDefault As Double) As Double
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetCapUint16")> _
        Public Shared Function GetCapUint16(ByVal cap As Int32, ByVal nDefault As Int32) As Int32
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetCapUint32")> _
...
' This is only valid in State 4 (TWAIN_SOURCE_OPEN) or higher.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetCapFix32")> _
        Public Shared Function SetCapFix32(ByVal Cap As Int32, ByVal dVal As Double) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetCapOneValue")> _
...
' Return Value: TRUE (1) if successful, FALSE (0) otherwise.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetCapFix32R")> _
...
' This is useful for languages that make it hard to pass double parameters.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetCapCurrent")> _
...
' returns FALSE.  If this function returns FALSE, *pVal is not touched.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_ToFix32")> _
...
' to e.g. TWAIN_SetCapOneValue
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_ToFix32R")> _
...
' Returns a TW_FIX32 value that approximates Numerator/Denominator
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_Fix32ToFloat")> _
...
'
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetCustomDataToFile")> _
        Public Shared Function GetCustomDataToFile(ByVal sFilename As String) As Boolean
        End Function
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetCustomDataFromFile")> _
...
' No file extension is assumed, you should provide one, such as ".dat".
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetCustomData")> _
...
' Same as TWAIN_SetCustomDataFromFile, but from a buffer in memory.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetCustomData")> _
...
' Returns 0 if the device doesn't support this, no device open, etc.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_CustomData")> _
...
' See the TWAIN Specification (version 1.9 or later) for details.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_IsExtendedInfoSupported")> _
...
' Returns TRUE(1) if yes, FALSE(0) if not.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_EnableExtendedInfo")> _
...
' and has no effect.  Otherwise (if successful) it returns TRUE.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_IsExtendedInfoEnabled")> _
...
' (for collection)
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_DisableExtendedInfo")> _
...
' retrieve the extended image info associated with that scan:
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_ExtendedInfoItemCount")> _
...
' Return the number of items of data available of the given info type.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_ExtendedInfoItemType")> _
...
' Returns the same TWTY_ codes as CONTAINER_ItemType.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_ExtendedInfoInt")> _
...
' Return the (integer) value of the 'nth' item of the specified extended info.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_ExtendedInfoFloat")> _
...
' Return the (floating point) value of the 'nth' item of the specified extended info.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetExtendedInfoString")> _
...
' Returns FALSE otherwise.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_ExtendedInfoString")> _
...
' In case of any failure, returns the empty string ("").
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetExtendedInfoFrame")> _
...
'--------- Lowest-level functions for TWAIN protocol --------
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_DS")> _
...
' condition code TWCC_NODS.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_Mgr")> _
...
' Functions to do a memory transfer in individual blocks:
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_BeginAcquireMemory")> _
...
' If nRows is <= 0, lets the driver pick the optimal block size.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_AcquireMemoryBlock")> _
...
' See the DIB_* functions for what can be done with the returned handle.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_EndAcquireMemory")> _
...
' In single-transfer mode (the default) the device is automatically closed.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_AcquireFile")> _
...
'  If the user cancels the Save File dialog, GetResultCode will be TWRC_CANCEL
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetImageReadyTimeout")> _
...
' this failure (otherwise the application has to be forcibly terminated.)
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_AutoClickButton")> _
...
' a device that insists on showing its user interface. 
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_BreakModalLoop")> _
...
' call appropriate functions to transition TWAIN as desired.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_EmptyMessageQueue")> _
...
'--------- Dosadi Special --------
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_BuildName")> _
...
' Return a string describing the build of EZTWAIN e.g. "Release - Build 6"
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetBuildName")> _
...
' in the string variable before calling this function.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetSourceIdentity")> _
        Public Shared Function GetSourceIdentity(ByVal ptwid As IntPtr) As Int32
        End Function

        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_GetImageInfo")> _
...
' at ptwinfo.  The returned structure is a TW_IMAGEINFO - see twain.h.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_LogFile")> _
...
' 4            log Windows messages flowing through EZTwain
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetLogFolder")> _
...
' by Windows version, search for the Windows API call GetTempPath.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SetLogName")> _
...
' TWAIN_SetLogName("c:\temp\scan2tape.log")
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_LogFileName")> _
...
' Return the (fully qualified) file path and name for logging.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_WriteToLog")> _
...
' Logging is controlled by TWAIN_LogFile - see above.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_SelfTest")> _
...
'   other  internal test failed.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_Blocked")> _
...
' ----------------------------------------------------
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_FreeNative")> _
        Public Shared Sub FreeNative(ByVal hdib As IntPtr)
        End Sub
' superceded by DIB_Free.

        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_NegotiatePixelTypes")> _
        Public Shared Function NegotiatePixelTypes(ByVal wPixMask As Int32) As Boolean
        End Function
' Legacy function
...
' TWAIN_SetPixelType to designate a single pixel type.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_AcquireNative")> _
        Public Shared Function AcquireNative(ByVal hwndApp As IntPtr, ByVal wPixMask As Int32) As IntPtr
        End Function
...
' to represent a set of more than one acceptable pixel type.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_AcquireMemory")> _
...
' known to EZTwain, that malfunctions with our default handling.
        ...
        <Interop.DllImport("Eztwain3.dll", CharSet:=Interop.CharSet.Ansi, ExactSpelling:=True, SetLastError:=False, EntryPoint:="TWAIN_AcquireToClipboard")> _
        Public Shared Function AcquireToClipboard(ByVal hwndApp As IntPtr, ByVal wPixMask As Int32) As Boolean
        End Function
