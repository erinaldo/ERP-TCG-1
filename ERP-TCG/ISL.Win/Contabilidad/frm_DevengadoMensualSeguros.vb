...
#Region "Botones"
    ...
    Public Overrides Sub Guardar()
        Try
            ...
            End If
            If tcSeguros.Tabs(0).Selected = True And tcSeguros.Tabs(1).Selected = False Then
                olAsiento.GuardarSegurosDevengados(dtPolizas, oePeriodo, gUsuarioSGI.Id, oeMoneda, decTC.Value, "POLIZA", PrefijoIdSucursal)
            ElseIf tcSeguros.Tabs(1).Selected = True And tcSeguros.Tabs(0).Selected = False Then
                olAsiento.GuardarSegurosDevengados(dtSoat, oePeriodo, gUsuarioSGI.Id, oeMoneda, decTC.Value, "SOAT", PrefijoIdSucursal)
            End If
