...
Public Class frm_FacturaCompra

#Region "Inicializacion de Formulario"

    Private Shared instancia As frm_FacturaCompra = Nothing
    ...
    Public Overrides Function getInstancia() As frm_MenuPadre
        If instancia Is Nothing Then
            ...
            instancia = New frm_FacturaCompra()
        End If
        instancia.Activate()
        Return instancia
    End Function
...
#Region "Metodos"
    ...
    Private Sub LlenaCombos()
        Try
            ...
            oeTipoDocumento.Id = "1CH000000026"
        ...
        Try
            ...
            With oeMovimientoDocumento
                ...
                Else
                    ...
                    If Not String.IsNullOrEmpty(txtNumero.Value) Then .Numero = FormatoDocumento(txtNumero.Value.ToString.Trim, 8)
                End If
                .TipoOperacion = "COM"
            End With
            With griListaFacturaCompra
    ...
    Private Sub Validar_ExistenciaComprobante()
        Try
            ...
            oeMovDocAUx.IdTipoDocumento = "1CH000000026"
    ...
    Private Sub CargarObjects()
        Try
            ...
            With oeMovimientoDocumento
                ...
                If Not String.IsNullOrEmpty(txtNumeroM.Value) Then .Numero = FormatoDocumento(txtNumeroM.Value.ToString.Trim, 8)
...
#End Region
    ...
    Private Sub ValidarTotalDetalle()
        Try
            Dim Total As Double = 0
            Dim flag As Boolean = False
