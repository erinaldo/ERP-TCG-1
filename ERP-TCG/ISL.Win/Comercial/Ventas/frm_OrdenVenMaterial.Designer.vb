...
Partial Class frm_OrdenVenMaterial
    ...
    Private Sub InitializeComponent()
        ...
        Dim UltraGridColumn6 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("IdTipoEmpresa")
        Dim UltraGridColumn7 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("TipoEmpresa")
        ...
        Dim UltraGridColumn9 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("Ruc")
        ...
        Dim UltraGridColumn12 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("IdDireccionTanqueo")
        ...
        Dim UltraGridColumn15 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("IndAgentePercepcion")
        Dim UltraGridColumn16 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("IndAgenteRetencion")
        Dim UltraGridColumn17 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("IndBuenContribuyente")
        Dim UltraGridColumn18 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("IndCanjeDocumento")
        Dim UltraGridColumn19 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("IndAceptaLetras")
        Dim UltraGridColumn20 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("IndAceptaCheque")
        Dim UltraGridColumn21 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("Morosidad")
        Dim UltraGridColumn22 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("Credito")
        Dim UltraGridColumn23 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("IndNivelComercial")
        Dim UltraGridColumn24 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("IndClasificacion")
        Dim UltraGridColumn25 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("IdMoneda")
        Dim UltraGridColumn31 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("Moneda")
        Dim UltraGridColumn32 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("IndCategoriaEmpresaSGI")
        Dim UltraGridColumn33 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("IndRelacionada")
        Dim UltraGridColumn34 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("DireccionFiscal")
        ...
        Dim UltraGridColumn35 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("CorreoEnvioXml")
        Dim UltraGridColumn36 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("CorreoEnvioXml2")
        ...
        Dim UltraGridColumn37 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("CorreoEnvioXml")
        Dim UltraGridColumn38 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("CorreoEnvioXml2")
        ...
        UltraGridColumn119.Header.Caption = "DocCanjeado"
        UltraGridColumn119.Header.VisiblePosition = 17
        UltraGridColumn119.Width = 149
        ...
        UltraGridColumn342.Header.VisiblePosition = 9
        UltraGridColumn342.Width = 300
        UltraGridColumn343.Header.VisiblePosition = 11
        UltraGridColumn343.Hidden = True
        UltraGridColumn344.Header.VisiblePosition = 8
        UltraGridColumn345.Header.VisiblePosition = 26
        UltraGridColumn345.Hidden = True
        UltraGridColumn346.Header.VisiblePosition = 10
        UltraGridColumn347.Header.VisiblePosition = 13
        UltraGridColumn347.Hidden = True
        UltraGridColumn348.Header.VisiblePosition = 15
        UltraGridColumn348.Hidden = True
        UltraGridColumn349.Header.VisiblePosition = 17
        UltraGridColumn349.Hidden = True
        UltraGridColumn350.Header.VisiblePosition = 24
        UltraGridColumn350.Hidden = True
        UltraGridColumn351.Header.VisiblePosition = 21
        UltraGridColumn351.Hidden = True
        UltraGridColumn352.Header.VisiblePosition = 22
        UltraGridColumn352.Hidden = True
        UltraGridColumn353.Header.VisiblePosition = 14
        UltraGridColumn354.Header.VisiblePosition = 16
        ...
        UltraGridColumn363.Header.VisiblePosition = 7
        ...
        UltraGridColumn367.Header.VisiblePosition = 9
        UltraGridColumn367.Width = 300
        UltraGridColumn368.Header.VisiblePosition = 11
        UltraGridColumn368.Hidden = True
        UltraGridColumn369.Header.VisiblePosition = 8
        UltraGridColumn370.Header.VisiblePosition = 26
        ...
        UltraGridColumn373.Header.VisiblePosition = 15
        UltraGridColumn373.Hidden = True
        UltraGridColumn374.Header.VisiblePosition = 17
        ...
        UltraGridColumn378.Header.VisiblePosition = 14
        UltraGridColumn379.Header.VisiblePosition = 16
        UltraGridColumn380.Header.VisiblePosition = 18
        UltraGridColumn381.Header.VisiblePosition = 19
        UltraGridColumn382.Header.VisiblePosition = 6
        UltraGridColumn382.Hidden = True
        UltraGridColumn383.Header.VisiblePosition = 23
        UltraGridColumn384.Header.VisiblePosition = 25
