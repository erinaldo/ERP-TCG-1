...
#Region "Asiento Modelo"
    ...
    Public Sub ObtenerAsientoModelo(IdMoneda As String, Ejercicio As Integer)
        Try
            ...
            If oeOrden.IdMovimientoInventario = "1CH000000038" Then
                cadSQL = "TipoRef2 = 4 AND IdRef2 = '" & IdMoneda & "' AND TipoRef1 = 3 and IdRef1 = '1CH000000038'"
            Else
                cadSQL = "TipoRef2 = 4 AND IdRef2 = '" & IdMoneda & "'"
            End If
