...
Public Class d_EstacionServicio
    ...
    Public Function mt_Guardar(ByVal oeEstacionServicio As e_EstacionServicio) As Boolean
        Try
            ...
            With oeEstacionServicio
                stResultado = sqlhelper.ExecuteScalar("STD.EstacionServicio_IAE",
                                              .TipoOperacion,
                                              .Id,
                                              .IdEmpresaSis,
                                              .IdSucursal,
    ...
    Public Function mt_Eliminar(ByVal oeEstacionServicio As e_EstacionServicio) As Boolean
        Try
            With oeEstacionServicio
                sqlhelper.ExecuteNonQuery("STD.EstacionServicio_IAE", "E", .Id, .IdEmpresaSis, .IdSucursal, .Nombre, .Estado, .Usuario)
            End With
            Return True
        Catch ex As Exception
            Throw ex
