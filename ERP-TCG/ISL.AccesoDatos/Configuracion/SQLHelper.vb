...
Public NotInheritable Class SqlHelper
    ...
    Public conexion As New d_Conexion
...
#End Region
    ...
    Public Function InsertarMasivo(ByVal NombreTabla As String, ByVal dt As Data.DataTable, Optional ByVal Transaccion As Boolean = True) As Boolean
        Dim d_conexion As New d_Conexion
        Dim con As New SqlConnection(d_conexion.CadenaConexionSGI)
        Try
            If Transaccion Then
                Using transScope As New TransactionScope()
                    GuardaMasivo(con, NombreTabla, dt)
                    transScope.Complete()
                End Using
            Else
                GuardaMasivo(con, NombreTabla, dt)
    ...
    Private Sub GuardaMasivo(ByVal con As SqlConnection, ByVal NombreTabla As String, ByVal dt As Data.DataTable)
