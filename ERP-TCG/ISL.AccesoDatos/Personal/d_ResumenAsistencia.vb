...
Public Class d_ResumenAsistencia
    ...
    Public Function Guardar(ByVal oeResumenAsistencia As e_ResumenAsistencia) As Boolean
        Try
            ...
            With oeResumenAsistencia
                sqlhelper.ExecuteNonQuery("PER.Isp_ResumenAsistencia_IAE", .TipoOperacion, d_DatosConfiguracion.PrefijoID, _
                        .Id _
                        , .IdPlanilla _
                        , .IdTrabajador _
                        , .IndTipo _
    ...
    Public Function UltimoIdInserta() As String
        Try
            ...
            stResultado = sqlhelper.ExecuteScalar("STD.Isp_UltimoId_Inserta", "PER.ResumenAsistencia", d_DatosConfiguracion.PrefijoID _
                                  )
            Return stResultado
        Catch ex As Exception
            Throw ex
