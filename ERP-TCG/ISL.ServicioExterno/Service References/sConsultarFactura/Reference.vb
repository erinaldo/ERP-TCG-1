...
Namespace sConsultarFactura
    
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0"),  _
     System.ServiceModel.ServiceContractAttribute([Namespace]:="http://service.sunat.gob.pe", ConfigurationName:="sConsultarFactura.billService")>  _
    Public Interface billService
        ...
        Function getStatus(ByVal request As sConsultarFactura.getStatusRequest) As <System.ServiceModel.MessageParameterAttribute(Name:="status")> sConsultarFactura.getStatusResponse
        ...
        <System.ServiceModel.OperationContractAttribute(Action:="urn:getStatusCdr", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults:=true)>  _
        Function getStatusCdr(ByVal request As sConsultarFactura.getStatusCdrRequest) As <System.ServiceModel.MessageParameterAttribute(Name:="statusCdr")> sConsultarFactura.getStatusCdrResponse
    End Interface
    ...
    Partial Public Class getStatusResponse
        ...
        <System.ServiceModel.MessageBodyMemberAttribute([Namespace]:="http://service.sunat.gob.pe", Order:=0),  _
         System.Xml.Serialization.XmlElementAttribute(Form:=System.Xml.Schema.XmlSchemaForm.Unqualified)>  _
        Public status As sConsultarFactura.statusResponse
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal status As sConsultarFactura.statusResponse)
            MyBase.New
            Me.status = status
        End Sub
    End Class
    ...
    Partial Public Class getStatusCdrResponse
        ...
        <System.ServiceModel.MessageBodyMemberAttribute([Namespace]:="http://service.sunat.gob.pe", Order:=0),  _
         System.Xml.Serialization.XmlElementAttribute(Form:=System.Xml.Schema.XmlSchemaForm.Unqualified)>  _
        Public statusCdr As sConsultarFactura.statusResponse
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal statusCdr As sConsultarFactura.statusResponse)
            MyBase.New
    ...
    Public Interface billServiceChannel
        Inherits sConsultarFactura.billService, System.ServiceModel.IClientChannel
    End Interface
    
    <System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")>  _
    Partial Public Class billServiceClient
        Inherits System.ServiceModel.ClientBase(Of sConsultarFactura.billService)
        Implements sConsultarFactura.billService
        ...
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function sConsultarFactura_billService_getStatus(ByVal request As sConsultarFactura.getStatusRequest) As sConsultarFactura.getStatusResponse Implements sConsultarFactura.billService.getStatus
            Return MyBase.Channel.getStatus(request)
        End Function
        
        Public Function getStatus(ByVal rucComprobante As String, ByVal tipoComprobante As String, ByVal serieComprobante As String, ByVal numeroComprobante As Integer) As sConsultarFactura.statusResponse
            Dim inValue As sConsultarFactura.getStatusRequest = New sConsultarFactura.getStatusRequest()
            ...
            Dim retVal As sConsultarFactura.getStatusResponse = CType(Me,sConsultarFactura.billService).getStatus(inValue)
            Return retVal.status
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function sConsultarFactura_billService_getStatusCdr(ByVal request As sConsultarFactura.getStatusCdrRequest) As sConsultarFactura.getStatusCdrResponse Implements sConsultarFactura.billService.getStatusCdr
            Return MyBase.Channel.getStatusCdr(request)
        End Function
        
        Public Function getStatusCdr(ByVal rucComprobante As String, ByVal tipoComprobante As String, ByVal serieComprobante As String, ByVal numeroComprobante As Integer) As sConsultarFactura.statusResponse
            Dim inValue As sConsultarFactura.getStatusCdrRequest = New sConsultarFactura.getStatusCdrRequest()
            inValue.rucComprobante = rucComprobante
            inValue.tipoComprobante = tipoComprobante
            inValue.serieComprobante = serieComprobante
            inValue.numeroComprobante = numeroComprobante
            Dim retVal As sConsultarFactura.getStatusCdrResponse = CType(Me,sConsultarFactura.billService).getStatusCdr(inValue)
