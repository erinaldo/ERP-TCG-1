...
Namespace sFacturacion
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0"),  _
     System.ServiceModel.ServiceContractAttribute([Namespace]:="http://service.sunat.gob.pe", ConfigurationName:="sFacturacion.billService")>  _
    ...
    Partial Public Class getStatusResponse
        ...
        <System.ServiceModel.MessageBodyMemberAttribute([Namespace]:="http://service.sunat.gob.pe", Order:=0),  _
         System.Xml.Serialization.XmlElementAttribute(Form:=System.Xml.Schema.XmlSchemaForm.Unqualified)>  _
        Public status As sFacturacion.statusResponse
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal status As sFacturacion.statusResponse)
            MyBase.New
            Me.status = status
        End Sub
    End Class
    ...
    Public Interface billServiceChannel
        Inherits sFacturacion.billService, System.ServiceModel.IClientChannel
    End Interface
    
    <System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")>  _
    Partial Public Class billServiceClient
        Inherits System.ServiceModel.ClientBase(Of sFacturacion.billService)
        Implements sFacturacion.billService
        ...
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function sFacturacion_billService_getStatus(ByVal request As sFacturacion.getStatusRequest) As sFacturacion.getStatusResponse Implements sFacturacion.billService.getStatus
            Return MyBase.Channel.getStatus(request)
        End Function
        
        Public Function getStatus(ByVal ticket As String) As sFacturacion.statusResponse
            Dim inValue As sFacturacion.getStatusRequest = New sFacturacion.getStatusRequest()
            inValue.ticket = ticket
            Dim retVal As sFacturacion.getStatusResponse = CType(Me,sFacturacion.billService).getStatus(inValue)
        ...
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function sFacturacion_billService_sendPack(ByVal request As sFacturacion.sendPackRequest) As sFacturacion.sendPackResponse Implements sFacturacion.billService.sendPack
        ...
        Public Function sendPack(ByVal fileName As String, ByVal contentFile() As Byte, ByVal partyType As String) As String
            ...
            inValue.contentFile = contentFile
            inValue.partyType = partyType
            Dim retVal As sFacturacion.sendPackResponse = CType(Me,sFacturacion.billService).sendPack(inValue)
