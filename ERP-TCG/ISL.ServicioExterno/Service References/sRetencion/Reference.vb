...
Namespace sRetencion
    
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0"),  _
     System.ServiceModel.ServiceContractAttribute([Namespace]:="http://service.sunat.gob.pe", ConfigurationName:="sRetencion.billService")>  _
    Public Interface billService
        ...
        Function getStatus(ByVal request As sRetencion.getStatusRequest) As <System.ServiceModel.MessageParameterAttribute(Name:="status")> sRetencion.getStatusResponse
        ...
        <System.ServiceModel.OperationContractAttribute(Action:="urn:sendBill", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults:=true)>  _
        Function sendBill(ByVal request As sRetencion.sendBillRequest) As <System.ServiceModel.MessageParameterAttribute(Name:="applicationResponse")> sRetencion.sendBillResponse
        ...
        <System.ServiceModel.OperationContractAttribute(Action:="urn:sendPack", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults:=true)>  _
        Function sendPack(ByVal request As sRetencion.sendPackRequest) As <System.ServiceModel.MessageParameterAttribute(Name:="ticket")> sRetencion.sendPackResponse
        
        'CODEGEN: El parámetro 'ticket' requiere información adicional de esquema que no se puede capturar con el modo de parámetros. El atributo específico es 'System.Xml.Serialization.XmlElementAttribute'.
        <System.ServiceModel.OperationContractAttribute(Action:="urn:sendSummary", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults:=true)>  _
        Function sendSummary(ByVal request As sRetencion.sendSummaryRequest) As <System.ServiceModel.MessageParameterAttribute(Name:="ticket")> sRetencion.sendSummaryResponse
    End Interface
    ...
    Partial Public Class getStatusResponse
        ...
        <System.ServiceModel.MessageBodyMemberAttribute([Namespace]:="http://service.sunat.gob.pe", Order:=0),  _
         System.Xml.Serialization.XmlElementAttribute(Form:=System.Xml.Schema.XmlSchemaForm.Unqualified)>  _
        Public status As sRetencion.statusResponse
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal status As sRetencion.statusResponse)
            MyBase.New
            Me.status = status
        End Sub
    End Class
    ...
    Public Interface billServiceChannel
        Inherits sRetencion.billService, System.ServiceModel.IClientChannel
    End Interface
    
    <System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")>  _
    Partial Public Class billServiceClient
        Inherits System.ServiceModel.ClientBase(Of sRetencion.billService)
        Implements sRetencion.billService
        ...
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function sRetencion_billService_getStatus(ByVal request As sRetencion.getStatusRequest) As sRetencion.getStatusResponse Implements sRetencion.billService.getStatus
            Return MyBase.Channel.getStatus(request)
        End Function
        
        Public Function getStatus(ByVal ticket As String) As sRetencion.statusResponse
            Dim inValue As sRetencion.getStatusRequest = New sRetencion.getStatusRequest()
            inValue.ticket = ticket
            Dim retVal As sRetencion.getStatusResponse = CType(Me,sRetencion.billService).getStatus(inValue)
            Return retVal.status
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function sRetencion_billService_sendBill(ByVal request As sRetencion.sendBillRequest) As sRetencion.sendBillResponse Implements sRetencion.billService.sendBill
        ...
        Public Function sendBill(ByVal fileName As String, ByVal contentFile() As Byte) As Byte()
            Dim inValue As sRetencion.sendBillRequest = New sRetencion.sendBillRequest()
            inValue.fileName = fileName
            inValue.contentFile = contentFile
            Dim retVal As sRetencion.sendBillResponse = CType(Me,sRetencion.billService).sendBill(inValue)
            Return retVal.applicationResponse
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function sRetencion_billService_sendPack(ByVal request As sRetencion.sendPackRequest) As sRetencion.sendPackResponse Implements sRetencion.billService.sendPack
        ...
        Public Function sendPack(ByVal fileName As String, ByVal contentFile() As Byte) As String
            Dim inValue As sRetencion.sendPackRequest = New sRetencion.sendPackRequest()
            inValue.fileName = fileName
            inValue.contentFile = contentFile
            Dim retVal As sRetencion.sendPackResponse = CType(Me,sRetencion.billService).sendPack(inValue)
            Return retVal.ticket
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function sRetencion_billService_sendSummary(ByVal request As sRetencion.sendSummaryRequest) As sRetencion.sendSummaryResponse Implements sRetencion.billService.sendSummary
        ...
        Public Function sendSummary(ByVal fileName As String, ByVal contentFile() As Byte) As String
            Dim inValue As sRetencion.sendSummaryRequest = New sRetencion.sendSummaryRequest()
            inValue.fileName = fileName
            inValue.contentFile = contentFile
            Dim retVal As sRetencion.sendSummaryResponse = CType(Me,sRetencion.billService).sendSummary(inValue)
            Return retVal.ticket
        End Function
    End Class
End Namespace
